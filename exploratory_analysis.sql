...
--  List distinct countries and total years of data per country
SELECT
  Country,
...
--  Compare life expectancy by 'Developed' vs 'Developing' status
SELECT
  Status,
  ROUND(AVG(`Life expectancy`), 2) AS Avg_LifeExpectancy,
...
--  Correlation-like exploration: Life expectancy vs GDP
SELECT
  Country,
  Year,
  `Life expectancy`,
...
-- Country with the highest increase in life expectancy from earliest to latest year
...
-- Avg BMI vs Life Expectancy per country
SELECT
  Country,
